...
import { Trash2, Play, Plus, Clock, Users, FileBarChart, Loader2, Settings, Eye, Pencil } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="grid gap-6">
            {tasks.map(task => (
              <div key={task.id} className={`bg-white dark:bg-zinc-800 rounded-lg shadow border p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 transition ${
                ...
                <div className="space-y-2 flex-1">
                  <div className="flex items-center space-x-3">
                    ...
                    <h3 className="text-xl font-semibold flex items-center gap-2">
                        {task.name}
                        {!task.enabled && <span className="text-[10px] font-normal px-1.5 py-0.5 rounded bg-zinc-200 dark:bg-zinc-700 text-zinc-500 uppercase tracking-tight">已禁用</span>}
                    </h3>
                  </div>
                ...
                <div className="flex items-center space-x-2 w-full md:w-auto">
                   <button 
                      ...
                      className="flex-1 md:flex-none flex items-center justify-center px-4 py-2 border border-zinc-300 dark:border-zinc-600 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-700 transition disabled:opacity-30"
                   >
